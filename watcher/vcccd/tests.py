...
class TestCourseAttributes(unittest.TestCase):
    ...
    def test_instructor(self):
        self.assertEqual(self.instructor, self.expected_values['instructor'])

    def test_meeting_time(self):
        self.assertEqual(self.meeting_time, self.expected_values['meeting_time'])

    def test_location(self):
        self.assertEqual(self.location, self.expected_values['location'])

    def test_status(self):
        self.assertEqual(self.status, self.expected_values['status'])

    def test_waitlist_availability(self):
        self.assertEqual(self.status, self.expected_values['waitlist_availability'])
